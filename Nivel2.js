    ...
    constructor() {
     ...
     create() { 
      ...
      platforms = this.physics.add.staticGroup();
         ...
         hongos.create(430,712,"hongo")
         hongos.create(520,390,"hongo")
         hongos.create(1000,220,"hongo")
         hongos.create(1500,712,"hongo")
         hongos.create(1250,470,"hongo")
         hongos.create(2000,600,"hongo")
         hongos.create(2200,600,"hongo")
         hongos.create(2170,600,"hongo")
         hongos.create(2240,600,"hongo")
         hongos.create(2500,600,"hongo")
         hongos.create(3200,490,"hongo")
         ...
         this.physics.add.overlap(player,hongos,this.quitavida,null,this)
         this.vida = 3 
...
scoregem.setText(this.score); 
     ...
     quitavida(){
       ...
       if (player.herido==false){
         ...
         vida=vida-1
         player.herido=true
         player.recuperar=this.time.now +3000
